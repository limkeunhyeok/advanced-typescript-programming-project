    ...
    <div class="outsideWrapper">
      <div class="insideWrapper">
        <img
          ...
          class="coveredImage"
          id="img"
          src="https://www.yogajournal.com/.image/t_share/MTQ3MTUyNzM1MjQ1MzEzNDg2/mountainhp2_292_37362_cmyk.jpg"
          alt="Pose"
          ref="poseId"
        />
        <canvas
...
export default class Pose extends Vue {
  ...
  private fields = {
    score: { label: "Confidence", sortable: true },
    part: { label: "Part", sortable: true },
    "position.x": { label: "X" },
    "position.y": { label: "Y" },
  };
